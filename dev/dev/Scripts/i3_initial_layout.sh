...
# TODO: make it so certain workspaces are replicated on monitor, some aren't
...
# workspace_names=("Plans" "Py" "3 26" "4 29" "Homelab" "tmp")
workspace_names=("Plans" "Py" "3 26" "4 29" "Homelab" "tmp" "prox" "media" "ansible")
