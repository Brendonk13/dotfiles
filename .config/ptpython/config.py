...
def configure(repl):
    ...
    # Vi mode, prefer to not have nested modal editing, also means I don't need the extra status line.
    repl.vi_mode = False
    ...
    # this set to false is desirable but doesnt work !! :(((
    ...
    # maybe try setting this so that alt-enter works instead of meta-enter
    # or can just keep using double-enter
