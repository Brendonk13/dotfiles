...
function! s:SetUpLoupeHighlight()
    " loupeHighlight is the current match
    execute 'highlight! LoupeHighlight ' . pinnacle#extract_highlight('IncSearch')
    " hi! link LoupeHighlight TermCursor
    " hi! link Search PMenu
    " hi! link IncSearch TermCursor
    " highlight! link Search VisualNOS
    highlight Search ctermbg=NONE guibg=NONE gui=bold guifg=#CE4444
    execute 'highlight Search ' . pinnacle#underline('Search')
  " execute 'highlight! LoupeHighlight ' . pinnacle#underline('IncSearch')
  " " execute 'highlight! LoupeHighlight ' . pinnacle#extract_highlight('IncSearch')
endfunction
